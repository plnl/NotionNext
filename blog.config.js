...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'plnl', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个IT从业小菜鸡，请各位大佬多多指教', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.bende.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Plnl, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP', // 备案号 闽ICP备XXXXXX
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个IT从业小菜鸡, 又菜又爱玩,Hi，请各位dalao多多指教,Welcome to Myblog🎉',
